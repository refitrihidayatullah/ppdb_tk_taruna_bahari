        ...
        <form action="{{url("/identitas_ortu/".$get_data_ortu->id_identitas_orangtua)}}" method="POST">
          ...
          <fieldset class="form-group">
            <div class="row">
              ...
              <div class="col-sm-10">
                <div class="form-check">
                  <input class="form-check-input" type="hidden" name="status_orangtua" value="{{$get_data_ortu->status_orangtua}}">
            ...
            <div class="form-group">
              <label for="nama_orangtua">Nama Lengkap Ayah*</label>
            ...
            <fieldset class="form-group">
              <div class="row">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="hidden" name="status_orangtua_dua" value="{{$get_data_ortu->status_orangtua_dua}}" id="gridRadios2" value="option2" checked>
              ...
              <div class="form-group">
                <label for="nama_orangtua">Nama Lengkap Ibu*</label>
                <input type="text" class="form-control @error('nama_orangtua') is-invalid @enderror" name="nama_orangtua_dua" value="{{$get_data_ortu->nama_orangtua_dua}}" id="nama_orangtua"  placeholder="masukkan nama orang tua siswa">
                @error('nama_orangtua')
                <div class="alert alert-danger" role="alert">
                    {{ $message}}
                </div>
              ...
              <div class="form-group">
                <label for="nik_siswa">Nik*</label>
                <input type="text" class="form-control @error('nik_orangtua') is-invalid @enderror" name="nik_orangtua_dua" value="{{$get_data_ortu->nik_orangtua_dua}}" id="nik_orangtua"  placeholder="masukkan nik orang tua">
                @error('nik_orangtua')
                <div class="alert alert-danger" role="alert">
                    {{ $message}}
                </div>
              ...
              <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    <label for="tanggal_lahir_orangtua">Tanggal Lahir*</label>
                    <input type="date" class="form-control @error('tanggal_lahir_orangtua') is-invalid @enderror" value="{{$get_data_ortu->tanggal_lahir_orangtua_dua}}" name="tanggal_lahir_orangtua_dua" id="tanggal_lahir_siswa">
                    @error('tanggal_lahir_orangtua')
                    <div class="alert alert-danger" role="alert">
                        {{ $message}}
                    </div>
                  ...
                  <div class="form-group col-md-4">
                  <label for="pendidikan_orangtua">Pendidikan Terakhir*</label>
                  <select class="form-control" name="pendidikan_orangtua_dua" id="pendidikan_orangtua">
                    @foreach ($pilihan_pendidikan as $pendidikan)
                    <option value="{{$get_data_ortu->pendidikan_orangtua_dua === $pendidikan ? $get_data_ortu->pendidikan_orangtua_dua : $pendidikan }}" {{$get_data_ortu->pendidikan_orangtua_dua === $pendidikan ? 'selected':''}}       
                      >
                      {{$pendidikan}}
                    </option>
                  ...
                  <div class="form-group col-md-4">
                    <label for="pekerjaan_orangtua">Pekerjaan*</label>
                    <select class="form-control" name="pekerjaan_orangtua_dua" id="pekerjaan_orangtua">
                      @foreach ($pilihan_pekerjaan as $pekerjaan)
                          
                      <option value="{{$get_data_ortu->pekerjaan_orangtua_dua === $pekerjaan ? $get_data_ortu->pekerjaan_orangtua_dua : $pekerjaan}}" {{$get_data_ortu->pekerjaan_orangtua_dua === $pekerjaan ? 'selected':''}}>{{$pekerjaan}}</option>
                      @endforeach
                    </select>
                    @error('pekerjaan_orangtua')
                    <div class="alert alert-danger" role="alert">
