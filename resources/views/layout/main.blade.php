...
<head>
    ...
    <title>PPDB - Tk Taruna Bahari</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <!-- cek href link berdasarkan auth user -->

            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/dashboard')}}">
                <div class="sidebar-brand-icon rotate-n-15">

                </div>
                <div class="sidebar-brand-text mx-3">PPDB Taruna Bahari</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseIndentitasSiswa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/identitas_siswa')}}">Identitas Siswa</a>
                    </div>
                </div>
            </li>
            @endif
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        ...
                        use Carbon\Carbon;
                        @endphp
                        <span>Copyright &copy; Tk Taruna Bahari {{ Carbon::now()->format('Y') }} | Refi Tri Hidayatullah</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
